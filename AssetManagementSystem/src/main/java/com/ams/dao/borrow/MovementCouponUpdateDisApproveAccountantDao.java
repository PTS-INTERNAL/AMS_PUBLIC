...
public class MovementCouponUpdateDisApproveAccountantDao {

	MovementCouponModel br=null;
	public MovementCouponUpdateDisApproveAccountantDao(MovementCouponModel br) {
		this.br = br;
	}

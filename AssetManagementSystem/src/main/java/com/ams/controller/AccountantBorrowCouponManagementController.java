...
public class AccountantBorrowCouponManagementController {
	String TITLE = "MÀN HÌNH QUẢN LÝ LỆNH ĐIỀU ĐỘNG CỦA KẾ TOÁN";
	...
	public ModelAndView initBorrow(HttpServletRequest request)
	{
		...
		MovementCouponModel br  = new MovementCouponModel();
		...
		br.setStatus("2");
		MovementCouponSelectDao BASD = new MovementCouponSelectDao(br);

	...
	<div style="padding: 0px;">
		<div class="row">
			<div class="col-sm-12 general-setting w3-hide-small w3-light-grey w3-card-2">
				<form action="MovementCouponManagmentDeptApprove" method="POST">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">CÔNG TY XUẤT:</label>
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">CÔNG TY NHẬP: </label>
								<div class="input-group">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">ĐƠN VỊ XUẤT:</label> <input type="text" value="${coupon.getDept_master().getDept_name()}" class="form-control" readonly="readonly" name="number_on">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="title_input">ĐƠN VỊ NHẬP:</label> <input type="text" value="${coupon.getDept_client().getDept_name()}" class="form-control" readonly="readonly" name="number_on">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
					...
					<table id="table.data" style="margin-top: 0px" class="table   table-data" style="margin-top: 10px">
						<thead>
							<tr>
								...
								<th style="width: 110px;">BÊN NGOÀI</th>
						...
						<tbody>
							...
							<c:forEach begin="${startIndex}" end="${lstBr.size()}" step="1" var="index">
								<tr>
									...
									<td style="text-align: center;"><input type="text" class="form-control" name="dept[<%=stt%>]" value="${coupon.getDept_master().getDept_name()}" readonly="readonly" style="display: block; height: 30px; margin: 2px;"></td>
									<td style="text-align: center;">
										<c:choose>
											<c:when test="${lstBr.get(index-1).getOuter() == 'on'}">
												<span class="form-control" readonly="readonly" name="outer[<%=stt%>]" style="display: block; height: 30px; margin: 2px; font-weight:700; color: green; font-size:30px; line-height:15px;">X</span>
											</c:when>
											<c:otherwise>
												<span  class="form-control" readonly="readonly" name="outer[<%=stt%>]"  style="display: block; height: 30px; margin: 2px;"></span>
											</c:otherwise>
										</c:choose>
					...
					<div class="row" style="margin-top: 10px;">
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" readonly="readonly" style="text-transform: uppercase;" class="form-control" name="reason_not_allow" value="${coupon.getReasonNotAllow()}">
								</div>
							</div>
						</div>
					</div>

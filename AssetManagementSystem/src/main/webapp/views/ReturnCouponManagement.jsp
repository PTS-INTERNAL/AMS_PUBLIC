			...
			<div class="col-sm-12 general-setting shadow-sm p-3 mb-5 bg-gray">
				...
				<c:if test="${lst.size() > 0}">
					<table id="table.data" style="margin-top: 0px" class="table   table-data" style="margin-top: 10px">
						...
						<input type="text" class="form-control" name="Current_Page" id="Current_Page" value="" style="display: none; height: 30px; margin: 2px;">
					</table>
					<div class="text-right">
						<%
							...
							if (stt > 13) {
								...
								%>
									<button 
									<% if(j==pagenum){%> style="background-color: red" <%} else{ %> 
...
<script type="text/javascript">
	...
	function setPage(i)
	{
		...
		document.getElementById("Current_Page").value = i;
